...
import com.teleeza.wallet.teleeza.rewarded_ads.utils.RewardedVideoAdsComparator;
import lombok.Data;

@Data
public class VideoAds extends RewardedVideoAdsComparator {
    ...
    public VideoAds(Long id, String title, String description, String filePath, String image, String question, String choiceA, String choiceB, String choiceC, String answer, String amount, Integer target_amount, String industry, String company, String duration, String brandLogo, String callToAction, String callToActionTextColor, String callToActionBackgroundColor, String callToActionUrl,
                    ...
                    String location, String gender, String age_group, boolean target_group, String target_groups) {
        this.id = id;
        this.title = title;
